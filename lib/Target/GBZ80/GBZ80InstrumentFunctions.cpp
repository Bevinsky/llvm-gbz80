//===-- GBZ80InstrumentFunctions.cpp - Insert instrumentation for testing ---===//
//
...
#define GBZ80_INSTRUMENT_FUNCTIONS_NAME "GBZ80 function instrumentation pass"
...
#define SYMBOL_PREFIX "GBZ80_instrumentation"
...
class GBZ80InstrumentFunctions : public FunctionPass {
public:
  static char ID;

  GBZ80InstrumentFunctions() : FunctionPass(ID) {
    initializeGBZ80InstrumentFunctionsPass(*PassRegistry::getPassRegistry());
  }

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return GBZ80_INSTRUMENT_FUNCTIONS_NAME; }
};

char GBZ80InstrumentFunctions::ID = 0;
...
bool GBZ80InstrumentFunctions::runOnFunction(Function &F) {
...
INITIALIZE_PASS(GBZ80InstrumentFunctions, "GBZ80-instrument-functions",
                GBZ80_INSTRUMENT_FUNCTIONS_NAME, false, false)

namespace llvm {

FunctionPass *createGBZ80InstrumentFunctionsPass() { return new GBZ80InstrumentFunctions(); }
